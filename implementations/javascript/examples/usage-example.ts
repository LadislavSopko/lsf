/**
 * LSF Format - TypeScript Usage Example
 * 
 * This file demonstrates the various ways to use the LSF format library in TypeScript.
 */

import { LSFSimple, LSFEncoder, LSFDecoder, lsfToJson, lsfToJsonPretty } from '../dist';

// Example 1: Simple API - The easiest way to use LSF
console.log('=== Example 1: Simple API ===');
