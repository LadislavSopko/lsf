...
namespace Zerox.LSF.TestPrompts;
        ...
        return new List<TestCase>
        {
            ...
            new TestCase
            {
                ...
                Data = new Dictionary<string, object?>
                {
                    ...
                    ["boolean_true"] = true,
                    ["boolean_false"] = false,
                    ["very_long_string"] = string.Concat(Enumerable.Repeat("Lorem ipsum dolor sit amet, ", 100)),
...
Remember: ""Perfection is achieved not when there is nothing more to add, but when there is nothing left to take away."" - Antoine de Saint-Exupéry",
                    ["tags"] = new List<string> { "programming", "clean code", "opinion", "best practices" },
                    ["views"] = 1523,
                    ["likes"] = 89,
                    ["comments"] = 23,
                    ["controversial"] = true
